# THEORA Phone Bridge (Reference Daemon)

Reference Python daemon that connects a phone-like node to THEORA Brain over WebSocket.
...
- `system.run` is disabled by default for safety.
  ...
  `THEORA_PHONE_BRIDGE_ALLOW_SYSTEM_RUN=1`.
