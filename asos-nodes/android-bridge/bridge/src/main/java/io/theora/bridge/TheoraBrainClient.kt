...
/**
 * THEORA Brain WebSocket Client for Android.
 * Mirrors the iOS ASOSBrainClient.swift architecture.
 *
 * Connects to ws://host:9090/v1/node?api_key=...
 * Registers as node_type: "phone", platform: "android"
 */
interface TheoraBrainDelegate {
    fun brainDidConnect()
...
class TheoraBrainClient(
    private val host: String,
    private val port: Int = 9090,
    private val apiKey: String,
    private val nodeId: String = "android-phone",
    private val delegate: TheoraBrainDelegate? = null,
) {
