"""
TheoraClient — Connect to a running THEORA Brain via HTTP + WebSocket.
...
logger = logging.getLogger("theora.sdk.client")


class TheoraClient:
    """HTTP + WebSocket client for the THEORA Brain API."""
