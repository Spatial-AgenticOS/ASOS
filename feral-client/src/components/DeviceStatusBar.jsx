...
export default function DeviceStatusBar({ devices = [], hr }) {
  ...
  return (
    <div className="flex items-center gap-1 overflow-x-auto px-4 py-2 bg-feral-surface/60 border-b border-feral-border backdrop-blur-md">
        ...
        return (
          <div
            ...
            className={`device-chip flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-medium transition-all ${
              connected
                ? 'bg-feral-accent-dim text-feral-accent border border-feral-accent/20 device-chip-in'
                : 'bg-feral-card text-feral-text-muted border border-feral-border'
            }`}
          >
