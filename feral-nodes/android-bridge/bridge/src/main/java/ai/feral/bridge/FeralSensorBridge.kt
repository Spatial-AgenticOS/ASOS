...
/**
 * FERAL Sensor Bridge for Android — Health Connect + Wearable sensors.
 * Reads health data and forwards it to the Brain via FeralBrainClient.
 */
class FeralSensorBridge(
    private val context: Context,
    private val brainClient: FeralBrainClient,
) {
