...
def seed_demo_memory(memory_store):
    ...
    episodes = [
        ...
        (now - 4 * day, "conversation", "Alex asked me to summarize the OpenClaw codebase for comparison. Created a detailed analysis showing Feral's advantages in hardware mesh and memory."),
