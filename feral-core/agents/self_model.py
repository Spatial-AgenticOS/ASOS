...
def build_runtime_line(frame=None) -> str:
    ...
    Example:
        Runtime: agent=feral version=2026.4.21 host=mbp os=Darwin model=openai/gpt-4o channels=telegram(@feral_bot) devices=wristband autonomy=hybrid capabilities=voice,vision,somatic,mdns,sdui,tool_genesis,mitosis
    """
