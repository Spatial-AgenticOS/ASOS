...
import ai.feral.app.ui.*
import ai.feral.app.ui.theme.FeralTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val prefs = getSharedPreferences("feral", MODE_PRIVATE)
        ...
        setContent {
            FeralTheme {
                FeralMobileApp(brainClient, prefs)
            }
        }
    }
