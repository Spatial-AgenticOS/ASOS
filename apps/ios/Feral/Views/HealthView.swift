...
struct HealthView: View {
    ...
    private var authorizationCard: some View {
        VStack(spacing: 12) {
            ...
            Text("Allow FERAL to read your health data from HealthKit to provide personalized insights.")
                .font(.caption)
    ...
    private var wristbandSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Connect your FERAL wristband via Bluetooth to stream real-time sensor data to the Brain.")
                .font(.caption)
                .foregroundColor(.secondary)
        }
        .padding()
