...
description: "Default Prometheus metrics emitted by the FERAL Brain, the bundled Grafana dashboard, and the alert rules that ship with it. Owned by W13 (FEATURE_STABILITY_ROADMAP §3.1 #4)."
---
