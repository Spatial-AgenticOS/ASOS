...
| `--demo` | — | Demo mode: simulated hardware, pre-seeded memory |
...
Launch FERAL in demo mode with simulated hardware and pre-seeded data.
...
| Option | Default | Description |
|--------|---------|-------------|
| `--scenario <name>` | — | Run a specific demo scenario |
| `--serve-port <n>` | `9090` | Brain server port |
