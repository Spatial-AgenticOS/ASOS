"""
THEORA Demo Scenarios — Scripted flows for recording killer demos.
...
logger = logging.getLogger("theora.demo.scenarios")
...
SCENARIO_DEVELOPER = {
    ...
    "steps": [
        {
            "type": "user_message",
            "text": "Hey THEORA, show me the system dashboard with all connected devices and skills",
...
SCENARIO_MESH = {
    ...
    "steps": [
        ...
        {
            "type": "user_message",
            "text": "THEORA, show me all connected devices and their status",
        ...
        {
            "type": "user_message",
            "text": "Thanks THEORA. What was my average heart rate during that coding session?",
