"""
THEORA Wake Word Detector — "Hey THEORA"
==========================================
...
logger = logging.getLogger("theora.wake_word")
...
class WakeWordDetector:
    ...
    def __init__(self, config: WakeWordConfig = None):
        self._config = config or WakeWordConfig(
            enabled=os.getenv("THEORA_WAKE_WORD", "false").lower() in ("true", "1", "yes"),
            phrase=os.getenv("THEORA_WAKE_PHRASE", "hey theora"),
            sensitivity=float(os.getenv("THEORA_WAKE_SENSITIVITY", "0.5")),
            timeout_seconds=float(os.getenv("THEORA_WAKE_TIMEOUT", "10")),
        )
