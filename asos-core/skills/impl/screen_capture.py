...
class ScreenCaptureSkill(BaseSkill):
    ...
    async def _capture(self, args: dict) -> dict:
        ...
        save_path = Path(args.get("path") or f"/tmp/theora_screen_{ts}.png").expanduser()
        ...
        if analyze or query:
            ...
            if scene and scene.available:
                ...
                data["analysis_error"] = "No VLM available. Set OPENAI_API_KEY or THEORA_VLM_PROVIDER."
