"""
THEORA Skill Marketplace — Discover, install, and manage community skills
===========================================================================
HTTP client for the THEORA registry (or GitHub-based index).
...
GITHUB_INDEX_URL = os.getenv(
    ...
    "https://raw.githubusercontent.com/Spatial-AgenticOS/theora-skills/main/index.json",
)
