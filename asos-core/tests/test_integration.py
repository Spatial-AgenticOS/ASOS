"""
THEORA Integration Tests — End-to-End Brain Testing
=====================================================
...
from models.protocol import (
    TheoraMessage, NodeRegisterPayload, TextCommandPayload,
...
def config(tmp_path):
    ...
    loader.user_home = tmp_path / ".theora"
...
class TestProtocolRoundtrip:
    ...
    def test_text_command_roundtrip(self):
        msg = TheoraMessage(
            ...
            payload=TextCommandPayload(text="Hello THEORA").model_dump(),
        )
        raw = msg.model_dump()
        ...
        assert parsed_payload.text == "Hello THEORA"
...
class TestFullPipeline:
    ...
    def test_hardware_triangle_scenario(self, config, skill_registry, memory, perception):
        """
        The THEORA Triangle: Phone (client) + Glasses (daemon) + Robot (daemon)
        """
