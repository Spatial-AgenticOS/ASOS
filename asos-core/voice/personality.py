"""
THEORA Voice Personality — SOUL.md + USER.md injection for voice
=================================================================
...
logger = logging.getLogger("theora.voice.personality")
...
class VoicePersonality:
    ...
    def get_voice_instructions(
        ...
        parts.append(
            "You are THEORA — a personal AI operating system that speaks naturally. "
