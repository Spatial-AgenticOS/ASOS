"""
Identity and system-prompt construction for the THEORA orchestrator.

Loads agent personality from ~/.theora/ files (IDENTITY.yaml, USER.md,
...
logger = logging.getLogger("theora.orchestrator.identity")
